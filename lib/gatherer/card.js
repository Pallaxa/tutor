...
(function() {
  ...
  module.exports = function(details, callback) {
    ...
    request({
      ...
      if (err) {
        return callback(err);
      } else if (res.request.uri.pathname !== '/Pages/Card/Details.aspx') {
  ...
  module.exports.url = function() {
    var id, k, name, o, page, params, path, rest, url, v, _i, _len;
    ...
    url += (id != null) && (name != null) ? "?multiverseid=" + id + "&part=" + (encodeURIComponent(name)) : id != null ? "?multiverseid=" + id : "?name=" + (encodeURIComponent(name));
    if (page > 1) {
      url += "&page=" + (page - 1);
    }
    return url;
